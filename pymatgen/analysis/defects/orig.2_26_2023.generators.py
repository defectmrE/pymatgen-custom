...
class ComplexMVGenerator:
    """
    Generator for Substitution-Vacancy (MV-type) complex defect
    ...
    def __init__(self, structure, element):
        """
        Initializes an ComplexMV generator using pymatgen structure and element object,
        ComplexMVGenerator relies on SubstitutionGenerator and VacancyGenerator.
        Args:
            structure (Structure): pymatgen structure object
            element (str or Element or Specie): element for substitutions
        """

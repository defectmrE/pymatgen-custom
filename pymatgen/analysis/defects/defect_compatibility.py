...
from pymatgen.analysis.defects.core import Vacancy, ComplexMV
...
class DefectCompatibility(MSONable):
    ...
    def check_final_relaxed_structure_delocalized(self, defect_entry):
        ...
        #if defindex is None and isinstance(defect_entry.defect, ComplexMV):
        #    pass

        if defindex is None and not isinstance(defect_entry.defect, (Vacancy, ComplexMV)):
        #if defindex is None and not isinstance(defect_entry.defect, ComplexMV):

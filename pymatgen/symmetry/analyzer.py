...
class SpacegroupAnalyzer:
    ...
    def get_sch_point_group_symbol(self):
        """
        Get the Schoenflies point group associated with the structure.

        Returns:
            (Pointgroup): Point group for structure.
        """
        hall_number = self._space_group_data["hall_number"]
        return spglib.get_spacegroup_type(hall_number)['pointgroup_international']

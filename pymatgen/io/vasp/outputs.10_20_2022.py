...
class Eigenval:
    ...
    def get_integer_occupancy_eigenvalues(self, corr=0):
        ...
        for spin, data in self.eigenvalues.copy().items():  # remove the k-point dimension
            d = data[0]
            d[:, 0] += corr
            egv_dict[spin] = d
...
def plot_defect_level_diagrams(eigenval, procar, defect_site_idx, vbm, cbm, align_corr=0,
